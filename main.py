...
agent=Agent('student1',[items[0].item_id,  items[20].item_id, items[25].item_id,items[30].item_id, items[40].item_id], 4)
bundle=[items[0],items[20], items[25], items[30], items[40]]
